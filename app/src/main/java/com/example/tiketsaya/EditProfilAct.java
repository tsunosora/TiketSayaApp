    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                xnama_lengkap.setText(dataSnapshot.child("nama_engkap").getValue().toString());
            ...
            public void onClick(View view) {
                ...
                reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dataSnapshot.getRef().child("nama_engkap").setValue(xnama_lengkap.getText().toString());
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onComplete(@NonNull Task<Uri> task) {
                                            //berpindah activity
                                            Intent gotoprofile = new Intent(EditProfilAct.this, MyProfileAct.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //berpindah activity
                Intent gotopbackrofile = new Intent(EditProfilAct.this, MyProfileAct.class);
                startActivity(gotopbackrofile);
            }
        });
